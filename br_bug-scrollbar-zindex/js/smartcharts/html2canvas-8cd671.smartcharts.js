 ...
 */
!function (A, e) {
  "object" == ( false ? undefined : _typeof(exports)) && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (A = A || self).html2canvas = e();
}(this, function () {
  "use strict";
  /*! *****************************************************************************
  ...
  var _K = function K() {
    return (_K = Object.assign || function (A) {
  ...
  var i,
    ...
    for (e = 0; e < o; e += 4) {
      t = Q[A.charCodeAt(e)], r = Q[A.charCodeAt(e + 1)], n = Q[A.charCodeAt(e + 2)], B = Q[A.charCodeAt(e + 3)], c[i++] = t << 2 | r >> 4, c[i++] = (15 & r) << 4 | n >> 2, c[i++] = (3 & n) << 6 | 63 & B;
    }
  ...
  var CA = {
    ...
    if (46 === t && iA(r)) for (A.push(this.consumeCodePoint(), this.consumeCodePoint()), e = 8; iA(this.peekCodePoint(0));) {
      A.push(this.consumeCodePoint());
    }
    t = this.peekCodePoint(0), r = this.peekCodePoint(1);
    var n = this.peekCodePoint(2);
    if ((69 === t || 101 === t) && ((43 === r || 45 === r) && iA(n) || iA(r))) for (A.push(this.consumeCodePoint(), this.consumeCodePoint()), e = 8; iA(this.peekCodePoint(0));) {
      A.push(this.consumeCodePoint());
    }
    return [function (A) {
      var e = 0,
  ...
  var it,
      at,
      ct = {
    "linear-gradient": function linearGradient(A) {
      var n = Qe(180),
          B = [];
      return WA(A).forEach(function (A, e) {
        if (0 === e) {
    ...
    "radial-gradient": function radialGradient(A) {
      var B = rt.CIRCLE,
    ...
    "-webkit-gradient": function webkitGradient(A) {
      var e = Qe(180),
          s = [],
  ...
  var BB = ["OL", "UL", "MENU"],
      sB = function sB(A, e, t) {
    for (var r = A.firstChild, n = void 0; r; r = n) {
      if (n = r.nextSibling, QB(r) && 0 < r.data.trim().length) e.textNodes.push(new Hn(r, e.styles));else if (wB(r)) {
        var B = oB(r);
  ...
  var LB,
    ...
    if (uB(A) && e) {
      ...
      for (var s = this.counters.parse(new un(r)), o = this.resolvePseudoContent(A, t, n, LB.BEFORE), i = A.firstChild; i; i = i.nextSibling) {
        wB(i) && ("SCRIPT" === i.tagName || i.hasAttribute(_B) || "function" == typeof this.options.ignoreElements && this.options.ignoreElements(i)) || this.options.copyStyles && wB(i) && nB(i) || t.appendChild(this.cloneNode(i));
      }
  ...
  var Os = (Ds.prototype.applyEffects = function (A, e) {
    ...
    if (!/(iPad|iPhone|iPod|Safari)/g.test(navigator.userAgent) && A.width === e && A.height === t) return A;
    ...
    return a(this, void 0, void 0, function () {
      ...
      return S(this, function (A) {
        switch (A.label) {
          case 0:
            O = b.styles.backgroundImage.length - 1, e = function e(_e2) {
              var t, r, n, B, s, o, i, a, c, Q, w, u, U, l, C, g, E, F, h, H, d, f, p, N, K, I, T, m, R, L, v;
              return S(this, function (A) {
                switch (A.label) {
                  case 0:
                    if (_e2.type !== xe.URL) return [3, 5];
                  ...
                  case 5:
                    ...
                    }(_e2) && (C = Hs(b, O, [null, null, null]), g = C[0], E = C[1], F = C[2], h = C[3], H = C[4], d = 0 === _e2.position.length ? [oe] : _e2.position, f = ae(d[0], h), p = ae(d[d.length - 1], H), N = function (A, e, t, r, n) {
                      var B = 0,
                          s = 0;
                    ...
                    }(_e2, f, p, h, H), K = N[0], I = N[1], 0 < K && 0 < K && (T = D.ctx.createRadialGradient(E + f, F + p, 0, E + f, F + p, K), fe(_e2.stops, 2 * K).forEach(function (A) {
                      return T.addColorStop(A.stop, te(A.color));
                    }), D.path(g), D.ctx.fillStyle = T, K !== I ? (m = b.bounds.left + .5 * b.bounds.width, R = b.bounds.top + .5 * b.bounds.height, v = 1 / (L = I / K), D.ctx.save(), D.ctx.translate(m, R), D.ctx.transform(1, 0, 0, L, 0, 0), D.ctx.translate(-m, -R), D.ctx.fillRect(E, v * (F - R) + R, h, H * v), D.ctx.restore()) : D.ctx.fill())) : (B = Hs(b, O, [null, null, null]), g = B[0], f = B[1], p = B[2], h = B[3], H = B[4], s = pe(_e2.angle, h, H), o = s[0], i = s[1], a = s[2], c = s[3], Q = s[4], (w = document.createElement("canvas")).width = h, w.height = H, u = w.getContext("2d"), U = u.createLinearGradient(i, c, a, Q), fe(_e2.stops, o).forEach(function (A) {
      ...
      return S(this, function (A) {
        switch (A.label) {
          case 0:
            ...
            return r = (Math.round(1e3 * Math.random()) + Date.now()).toString(16), n = EB(p) || function (A) {
            ...
            }(e) : T(p), B = n.width, s = n.height, o = n.left, i = n.top, a = _K({}, {
              allowTaint: !1,
              imageTimeout: 15e3,
              proxy: void 0,
              useCORS: !1
              ...
              height: Math.ceil(s),
              id: r
            }, Q = _K({}, c, a, N), w = new I(Q.scrollX, Q.scrollY, Q.windowWidth, Q.windowHeight), De.create({
              id: r,
              enabled: Q.logging
...
//# sourceMappingURL=html2canvas-8cd671.smartcharts.js.map