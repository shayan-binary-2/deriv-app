(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@deriv/components/lib/desktop-wrapper"), require("@deriv/components/lib/desktop-wrapper.css"), require("@deriv/components/lib/div100vh-container"), require("@deriv/components/lib/div100vh-container.css"), require("@deriv/components/lib/mobile-wrapper"), require("@deriv/components/lib/mobile-wrapper.css"), require("@deriv/components/lib/themed-scrollbars"), require("@deriv/components/lib/themed-scrollbars.css"), require("@deriv/shared"), require("react"));
	else if(typeof define === 'function' && define.amd)
		define(["@deriv/components/lib/desktop-wrapper", "@deriv/components/lib/desktop-wrapper.css", "@deriv/components/lib/div100vh-container", "@deriv/components/lib/div100vh-container.css", "@deriv/components/lib/mobile-wrapper", "@deriv/components/lib/mobile-wrapper.css", "@deriv/components/lib/themed-scrollbars", "@deriv/components/lib/themed-scrollbars.css", "@deriv/shared", "react"], factory);
	else if(typeof exports === 'object')
		exports["@deriv/account"] = factory(require("@deriv/components/lib/desktop-wrapper"), require("@deriv/components/lib/desktop-wrapper.css"), require("@deriv/components/lib/div100vh-container"), require("@deriv/components/lib/div100vh-container.css"), require("@deriv/components/lib/mobile-wrapper"), require("@deriv/components/lib/mobile-wrapper.css"), require("@deriv/components/lib/themed-scrollbars"), require("@deriv/components/lib/themed-scrollbars.css"), require("@deriv/shared"), require("react"));
	else
		root["@deriv/account"] = factory(root["@deriv/components/lib/desktop-wrapper"], root["@deriv/components/lib/desktop-wrapper.css"], root["@deriv/components/lib/div100vh-container"], root["@deriv/components/lib/div100vh-container.css"], root["@deriv/components/lib/mobile-wrapper"], root["@deriv/components/lib/mobile-wrapper.css"], root["@deriv/components/lib/themed-scrollbars"], root["@deriv/components/lib/themed-scrollbars.css"], root["@deriv/shared"], root["react"]);
